                    ...
                    <Grid container spacing={3}>
                        <Grid item xs={12}>
                            <Paper className={classes.paper}><Typography />
                                <h1>Valores</h1>  <img src={Valores} alt="" /><p>
                                    <h2>Empoderamento</h2> <h3>Acreditamos no poder do empoderamento feminino para transformar vidas e impulsionar mudanças positivas na sociedade.</h3>
                        ...
                        <Grid item xs={12}>
                            <Paper className={classes.paper}>
                                <h1>Visão</h1>  <img src={Visao} alt="" /><p></p>
                        ...
                        <Grid item xs>
                            <Paper className={classes.paper}><h1>Missao</h1><img src={Missao} alt="" /><p></p><h3>
